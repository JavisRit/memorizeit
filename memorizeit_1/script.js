...
function nextRound() {
  ...
  setTimeout(
     () => humanTurn(sequence.length) , sequence.length * 600 + 1000
  );
}
...
window.onload = function() {
  const songs = [
    '/memorizeit_1/sound/music_easy.mp3'
  ];
...
function swapBG(level){
  if(level <6){
    document.body.style.backgroundImage = "url('image/background_1.gif')"
  } else if(level == 6){
    document.body.style.backgroundImage = "url('image/background_2.gif')"
  }else if(level == 11){
    document.body.style.backgroundImage = "url('image/background_3.gif')"
  } else {
    document.body.style.backgroundImage = "url('image/background_4.gif')"
  }
